...
[.output]
----
pullSecret: '{"auths":{"ip-10-0-56-192.ap-southeast-1.compute.internal:8443":{"auth":"aW5pdDpkaXNjb3Bhc3M="}}}'
----
...
imageContentSources:
  - mirrors:
    - ip-10-0-56-192.ap-southeast-1.compute.internal:8443/openshift/release-images
    source: quay.io/openshift-release-dev/ocp-release
  - mirrors:
    - ip-10-0-56-192.ap-southeast-1.compute.internal:8443/openshift/release
...
INFO     export KUBECONFIG=/mnt/high-side-data/auth/kubeconfig
INFO Access the OpenShift web-console here: https://console-openshift-console.apps.disco.lab
INFO Login to the console with user: "kubeadmin", and password: "YCYDn-S8mKw-cNCvo-nKCY7"
