...
This is also known as installing OpenShift in a https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/installing_on_aws/installer-provisioned-infrastructure#installing-restricted-networks-aws-installer-provisioned[_restricted network_ or an _air gap network_,window=_blank].
